...
-  É um trabalho minucioso, mas gratificante, e muito necessário.
:::
...
## O trabalho do taxonomista de Annelida é na lupa e no microscópio
...
:::box
"RELEMBRANDO: A **taxonomia** descreve a biodiversidade, a **classificação** procura algum tipo de ordem e a **sistemática** apresenta um sistema geral de referência (Amorim, 2005)."
:::

:::{.fragment}
> -   **Taxonomia** descreve, nomea e classifica os seres vivos.  
-   **Classificação** separa os organismos em grupos, baseado num conjunto de *critérios (ou parâmetros)* pré-estabelecidos.
...
<!-------################ sd ##############-------->
## Sistema de classificação zoológica

::: {style="font-size: 0.8em;"}
Em Botânica (reino Plantae) difere o filo, que vira divisão.
:::
...
<!-------################ sd ##############-------->
## Darwin & Wallace e a origem das espécies por seleção natural (1858){.smaller}
...
<!-------################# sd #################-------->
## Processo de anagênese: 

Especiação *alopátrica*, ocasionada por barreira geográfica (isolamento reprodutivo), como no ístmo do Panamá. 
...
## Plesiomorfias e apomorfias {.smaller}

::: {style="font-size: 0.76em;"}
-   Plesiomorfia: estado ancestral de um caráter. Já estava presente em ancestrais e, por isso, não define sozinha um grupo mais recente. Ex: coluna vertebral em mamíferos é plesiomorfia.
-   Apomorfia: estado derivado de um caráter. É uma característica evolutivamente nova em relação ao estado ancestral. Tipos de apomorfia:
    -   Sinapomorfia: é uma apomorfia compartilhada por dois ou mais grupos. Define grupo monofilético (provenientes de um ancestral comum) e constrói clados. Ex: Pelos e glândulas mamárias nos mamíferos.
    -   Autapomorfia: é uma apomorfia exclusiva de um único táxon terminal, mas que não agrupa nada. Ex: bico córneo do ornitorrinco, que é único entre os mamíferos. 
:::

![](images/Apom_Plesiom.png)

## Exemplos de sinapomorfia: {.smaller}
...
![](images/Filogenia_Metazoa_Simples.png)
